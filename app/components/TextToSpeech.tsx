...
import {CreateSoundRequest} from "@/app/models/data";
...
export function TextToSpeech({ data }: TextToSpeechProps) {
    ...
    function onButtonClick() {
        ...
        const soundRequest: CreateSoundRequest = {
            modelUrl: "https://api-inference.huggingface.co/models/facebook/fastspeech2-en-ljspeech",
            text: data,
        };

        // Call the provided handler function with the sound request
        handleGetAudio(soundRequest).then(()=>{
    ...
    return (
        <div className="ml-8 mr-8">
            <button type="button"
                    ...
                    className="text-black focus:ring-4 focus:outline-none focus:ring-amber-600font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-2 dark:hover:bg-amber-300">
                <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                     xmlns="http://www.w3.org/2000/svg"
                     fill="currentColor" viewBox="0 0 24 24">
                    <path
                        d="M13 6a2 2 0 0 0-3.3-1.5l-4 3.4H4a2 2 0 0 0-2 2V14c0 1.2.9 2 2 2h1.6l4.1 3.5A2 2 0 0 0 13 18V6Z"/>
